...
describe("GitWorktreeService", () => {
	...
	describe("validateWorktreeName", () => {
		it("should accept valid worktree names", () => {
			const validNames = ["feature-branch", "task-123", "hotfix_urgent", "dev-environment", "test123"];
		...
		it("should reject invalid worktree names", () => {
			const invalidCases = [
				...
				{ name: "   ", expectedError: "Worktree name cannot be empty" },
				{
					...
					expectedError: "Worktree name can only contain letters, numbers, hyphens, and underscores",
				},
				{
