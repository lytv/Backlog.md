...
export default function DocumentationDetail({docs, onRefreshData}: DocumentationDetailProps) {
    ...
    const handleDelete = useCallback(async () => {
        ...
        try {
            ...
            // Refresh data and navigate back to documentation list
            await onRefreshData();
            navigate('/documentation');
        } catch (err) {
    ...
    }, [id, isNewDocument, onRefreshData, navigate]);
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md w-full mx-4">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
                            Are you sure you want to delete "{docTitle || document?.title}"? This action cannot be undone.
                        </p>
