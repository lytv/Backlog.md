        ...
        <div className="border border-gray-200 dark:border-gray-600 rounded-lg transition-colors duration-200">
          ...
          {showClaudeCommand && (
            <div className="border-t border-gray-200 dark:border-gray-600">
              {/* Tab Navigation */}
              <div className="grid grid-cols-4 border-b border-gray-200 dark:border-gray-600">
                <button
                  type="button"
                  onClick={() => setActiveClaudeTab('send')}
                  className={`px-3 py-3 text-xs font-medium transition-colors duration-200 ${
                ...
                <button
                  type="button"
                  onClick={() => setActiveClaudeTab('bash')}
                  className={`px-3 py-3 text-xs font-medium transition-colors duration-200 ${
                    activeClaudeTab === 'bash'
                ...
                >
                  <div className="flex items-center justify-center gap-1">
                    ...
                    <span className="hidden sm:inline">Bash Command</span>
                    <span className="sm:hidden">Bash</span>
                  </div>
                </button>
                <button
                  type="button"
                  onClick={() => setActiveClaudeTab('bashOutput')}
                  className={`px-3 py-3 text-xs font-medium transition-colors duration-200 ${
                    activeClaudeTab === 'bashOutput'
                      ? 'bg-white dark:bg-gray-800 text-orange-600 dark:text-orange-400 border-b-2 border-orange-600 dark:border-orange-400'
                      : 'bg-gray-50 dark:bg-gray-700 text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200'
                  }`}
                >
                  <div className="flex items-center justify-center gap-1">
                    ...
                    <span className="hidden sm:inline">Bash Output</span>
